...
(function (html) {
     ...
     * ------------------------------------------------------ */
    const ssCertificateModals = function () {

        // Open modal when clicking certificate image
        document.querySelectorAll('.cert-card__image-wrapper img').forEach(img => {
        ...
        document.querySelectorAll('[id*="cert-modal-"]').forEach(modal => {
        ...
        document.addEventListener('keydown', function (e) {
            if (e.key === 'Escape') {
                document.querySelectorAll('[id*="cert-modal-"]:not([hidden])').forEach(modal => {
